...
public class MainActivity extends Activity implements OnClickListener, OnItemClickListener
{
...

    {
        ...
        do
        {
            ...
            try {
                 data2 =  cursor.getString( indexAddr ) +"\n" + StringCryptor.encrypt( new String(SmsReceiver.PASSWORD), str );
            } catch (Exception e) {
                e.printStackTrace();
            }
//data 2 for encrypted ms and str for decryptted msg
            smsList.add( data2 );
        }
